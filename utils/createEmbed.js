...
async function createEmbed(id) {
    ...
    let meter = '🀰'  // 16 = 100%, so percentages will be divided by 4 to create their meter
    let color = Number(id) % 2 === 0 ? '#ffffff' : '#000000'
    ...
    let ending = statusObj.timestamp
    ...
    let embed = new MessageEmbed()
        ...
        .addFields (
            ...
            inline: false } ,
            { name: meter.repeat(Math.floor(yes_percent / 6)) || empty,  // 🀰🀰🀰🀰
            value: '- - '.repeat(10), 
            inline: false
            },
            { name: altText("Reject:"), 
